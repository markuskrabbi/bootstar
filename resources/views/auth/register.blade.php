    ...
    <div class="card-body">
        <form method="POST" action="{{ route('register') }}">
            ...
            <label class="form-control w-full">
                ...
                <input type="text" name="name" placeholder="Name" value="{{ old('name') }}" class="input input-bordered w-full" />
                <div class="label">
                    @error('name')
            ...
            <label class="form-control w-full">
                ...
                <input type="password" name="password_confirmation" placeholder="Password Confirmation" class="input input-bordered w-full" />
                <div class="label">
